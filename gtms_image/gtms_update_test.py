'''
Python Script for making requests to GTMS instance.
...
class TestCaseVerdict:
    '''
    Class for handling GTMS requests.
    '''
    def __init__(self, hostname, username, pw, testcaseid, jobinstance,
    ...
    def init_gtms_headers(self):
        '''
            Login to the GTMS instance and retrieved the token.
    ...
    def login(self):
        ...
        '''
        result = subprocess.run(["./login_get_token.sh", self._hostname, self._username, self._pw],
...
def main(hostname, username, password, testcaseid, jobinstance,
        testcaseversion, softwareversion, verdict):
    '''
        Args: hostname: URL of the GTMS instance.
              username: Username for the GTMS user.
              pw: Password for the GTMS user.
        ...
        Function: Creates testverdict obj with all neccessary members.
                  Login to the GTMS instance and get the headers including the token.
                  Through a request to the GTMS instance; Create a test case verdict.
                  Get the json reply and convertes/saves into a xml file.
    '''
    testverdict_obj = TestCaseVerdict(hostname, username, password, testcaseid, jobinstance,
                                     testcaseversion, softwareversion, verdict)
    testverdict_obj.init_gtms_headers()
